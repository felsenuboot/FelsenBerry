...
5i. **SOAK #5 = second human-bar attempt** — **LIVE: SchnoddSchorsch, 25600:3162, join 2026-09-03T10:30:54.879Z; GRADED WINDOW (pre-registered at T+30, 11:03Z): 10:31:20Z → 11:31:20Z** — preflight ran ON the soak bot after join (13 /eval fixture hits 10:31:06–10:31:15Z, four synthetic `driver` episode closes); those are not human help but the instrument can't tell, so the window starts 5s after the last preflight eval. Lesson → law: run preflight on a throwaway, or take the join timestamp AFTER preflight. decider pid 180453 (PRE-REGISTERED 2026-09-03 ~10:30Z): server 25600 on fresh world-soak5 (25599 stays free for
   tests; hygiene law: nothing within 200 blocks of the soak bot on 25600). Stack: skills 63 / agenda 34 / survival 13 / dangerscan 6
   (preflight 261/261, assert-produce skipped-empty-inv). Aboard since soak #4: #109 decider grace, #110 remedy escalation, #112 standdown,
   #113/#114 foods, #115 multi-threat, #116 spawn camp, #117 eat deadlock, GOAL c3 vitals floor (hp≤6/food0 >10 min), trail vacuity flag.
