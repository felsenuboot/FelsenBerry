...
port = sys.argv[1]
total = passed = 0
for f in ['stack-check', 'tier-choice', 'move-detect', 'agenda-ladder', 'agenda-deepkit', 'agenda-resume', 'agenda-idlework', 'assert-produce', 'gotoR-recovery', 'agenda-idlekit', 'agenda-hunter-route']:
