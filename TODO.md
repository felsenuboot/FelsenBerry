...
7. **POST-SOAK-#5 QUEUE** (from issue-manager's 2026-09-03 tracker triage; order by blast radius on the human bar):
   ...
   ~~RUN #7~~ CONCLUDED 12:39Z (f6300c8): **DNF at wood, DEAD-STOP** — REFLEX panic non-clearance on a creeper at 13–16 blocks (los:false, ranged:false, 15 fires, HP/food/position flat 5 min) = TODO 5r. Positive: the food-kit wall did NOT recur as a blocker — two refusals self-healed via #120/#114. Wood T+1m13s, 0 deaths, 1 steering call. Specimen GrantigGustav left alive on 25600:3161 for engine-dev (5r). Stack 65/36/13/6/producer 9. Run #8 after soak #6. #103 done; #104 low.
