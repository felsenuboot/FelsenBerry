...
3. survives real night threats **without driver help**, and **without sustained critical vitals** — never hp ≤6 or food 0 for more than 10 continuous minutes (refinement adopted 2026-09-03 after soak #4 passed this criterion while at food 0 for 32.5 continuous minutes; hp ≤6 = 3 hearts, deliberately between survival.js CRIT=4 and hpPanic=8 — a human at ≤3 hearts for 10 min is not "safe"; applies from soak #5 on — soak #4's pre-registered grade stands as graded);
